...
<div class="page-main-style">
	...
	<ul style="list-style:none;  " >
		<li style="display: inline; ">
			<input type="button" id="team" class="btn" value="팀랭킹" onclick="location.href='${pageContext.request.contextPath}/team/totalFootRank.do'">
		</li>
		<li style="display: inline; ">
			<input type="button" id="member" class="btn" value="개인랭킹" onclick="location.href='${pageContext.request.contextPath}/team/totalFootMemRank.do'">
		</li>
	</ul>
	</div>
	<br>
	...
	<div class="memList">
		<table class="ranking">
			<tr>
				...
				<th>프로필</th>
				<th>이름</th>
				<th><a href='${pageContext.request.contextPath}/team/totalFootMemRank.do?morder=f_shoot'>슈팅</a></th>
				<th><a href='${pageContext.request.contextPath}/team/totalFootMemRank.do?morder=f_assist'>도움</a></th>
				<th><a href='${pageContext.request.contextPath}/team/totalFootMemRank.do?morder=f_goal'>득점</a></th>
				<th><a href='${pageContext.request.contextPath}/team/totalFootMemRank.do?morder=f_attack'>공격포인트</a></th>
			</tr>
			<c:if test="${count>0 }">
