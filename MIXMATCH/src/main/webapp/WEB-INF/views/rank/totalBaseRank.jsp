...
<div class="page-main-style">
	...
	<table  class="ranking">
			<tr>
				...
				<th>팀명</th>
				<th>연고지</th>
				<th><a href='${pageContext.request.contextPath}/team/totalBaseRank.do?order=t_win'>승리</a></th>
				<th><a href='${pageContext.request.contextPath}/team/totalBaseRank.do?order=t_draw'>무승부</a></th>
				<th><a href='${pageContext.request.contextPath}/team/totalBaseRank.do?order=t_lose'>패배</a></th>
			</tr>
		<c:if test="${count>0 }">
		<c:forEach var="list" items="${list}">
			<tr>
				...
				<c:if test="${fn:endsWith(list.t_logo_name, '.jpg') || fn:endsWith(list.t_logo_name, '.png') || fn:endsWith(list.t_logo_name, '.gif') || fn:endsWith(list.t_logo_name, '.JPG') || fn:endsWith(list.t_logo_name, '.PNG') || fn:endsWith(list.t_logo_name, '.GIF')}">
					<img src="${pageContext.request.contextPath}/team/imageView.do?t_name=${list.t_name}" style="width:100px;height:100px;">
				</c:if> 
