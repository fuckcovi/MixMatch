...
<div class="match-div">
	<h3 style="text-align:left;font-weight:bold;">매치수정</h3>
	...
	<div class="match-form">
		<form:form class="style" commandName="match" action="matchUpdate.do" enctype="multipart/form-data" id="update_form">
			...
			<table class="insert-table">
				...
				<tr height="30">
					<th>날짜</th>
					<td><input type="date" name="m_date" id="m_date" value="${match.m_date}" class="option-box"></td>
				</tr>
				<tr height="30">
					<th>시간</th>
					<td>
				...
				<tr height="30">
					<th>비용</th>
					<td><input type="number" name="m_cost" value="${match.m_cost}" step="1000" class="option-box"/></td>
				</tr>
				<tr height="80">
					<th>내용</th>
