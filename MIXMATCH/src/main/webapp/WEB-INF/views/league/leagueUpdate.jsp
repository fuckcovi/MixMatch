...
<div class="match-div">
	<h3 style="text-align:left;font-weight:bold;">리그수정</h3>
	<hr class="match-hr"><br>
	
	<div class="match-form">
		<form:form class="style" commandName="league" action="leagueUpdate.do" enctype="multipart/form-data">
			<form:hidden path="l_seq" value="${league.l_seq}"/>
			<form:hidden path="id" value="${league.id}"/>
			<form:hidden path="l_team" value="${league.l_team}"/>
			<table class="insert-table">
				...
				<tr>
					<th>날짜</th>
					<td><input type="date" name="l_date" id="l_date" class="option-box" value="${league.l_date}"></td>
				</tr>
				<tr>
					<th>시간</th>
					<td>
				...
				<tr>
					<th>비용</th>
					<td><input type="number" name="l_cost" value="${league.l_cost}" step="1000" class="option-box"/></td>
				</tr>
				<tr>
					<th>모집팀수</th>
					<td>
			...
			<br>
			<input type="submit" value="수정" class="match-btn">
		</form:form>
	</div>
</div>