...
<div id="header2">
	<div id="topMenu">
		<ul>
			<li class="topMenuLi">
				<a class="menuLink" href="${pageContext.request.contextPath}/notice/notice.do">게시판</a>
				<ul class="submenu">
				<li><a href="${pageContext.request.contextPath}/notice/notice.do" class="submenuLink">공지사항</a></li>
				<li><a href="${pageContext.request.contextPath}/board/list.do" class="submenuLink">자유게시판</a></li>
				<li><a href="${pageContext.request.contextPath}/teamboard/teamboard.do" class="submenuLink">팀게시판</a></li>
				</ul> 
			</li>
			<li class="topMenuLi">
			...
			<li class="topMenuLi">
				<a class="menuLink" href="${pageContext.request.contextPath}/team/totalRank.do">기록/랭킹</a>
				<ul class="submenu">
					<li><a href="${pageContext.request.contextPath}/team/totalRank.do" class="submenuLink">통합P랭킹</a></li>
					<li><a href="${pageContext.request.contextPath}/team/totalBaseRank.do" class="submenuLink">야구랭킹</a></li>
					<li><a href="${pageContext.request.contextPath}/team/totalBasketRank.do" class="submenuLink">농구랭킹</a></li>
					<li><a href="${pageContext.request.contextPath}/team/totalFootRank.do" class="submenuLink">축구랭킹</a></li>
				</ul>
			</li>
			<li class="topMenuLi">
