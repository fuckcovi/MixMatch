...
public class TeamBoardController {
	...
	@RequestMapping("/teamboard/teamboard.do")
	...
	@RequestMapping("/teamboard/teamboardDetail.do")
	...
	// 이미지 출력
	@RequestMapping("/teamboard/teamboardimageView.do")
	...
	@RequestMapping(value="/teamboard/teamboardInsert.do",method=RequestMethod.GET)
	...
	@RequestMapping(value="/teamboard/teamboardInsert.do",method=RequestMethod.POST)
	...
	// 글 수정
	@RequestMapping(value="/teamboard/teamboardUpdate.do", method=RequestMethod.POST)
	...
	// 글 삭제
	@RequestMapping("/teamboard/teamboardDelete.do")
