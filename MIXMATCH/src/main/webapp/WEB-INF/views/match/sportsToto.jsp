...
<div class="match-div">
	<h3 style="text-align:left;font-weight:bold;">승부예측</h3>
				...
				<c:forEach var="match" items="${list}">
					<c:if test="${!empty match.m_challenger && match.m_home eq -1}">
						<tr> 
							...
							<td><input type="button" value="배당률" class="match-btn" onClick="location.href='totoDetail.do?m_seq=${match.m_seq}'"></td>
						</tr>
					</c:if>
				</c:forEach>	
			</c:if> 
